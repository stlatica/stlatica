...
export const getFollowUsers = (
    ...
    return axios.get(
      `http://localhost:4010/internal/v1/users/${userId}/follows`,{
    ...options,
        params: {...params, ...options?.params},}
    );
  }
...
export const getGetFollowUsersKey = (userId: string,
    params?: GetFollowUsersParams,) => [`http://localhost:4010/internal/v1/users/${userId}/follows`, ...(params ? [params]: [])] as const;
...
export const getFollowers = (
    ...
    return axios.get(
      `http://localhost:4010/internal/v1/users/${userId}/followers`,{
    ...options,
        params: {...params, ...options?.params},}
    );
  }
...
export const getGetFollowersKey = (userId: string,
    params?: GetFollowersParams,) => [`http://localhost:4010/internal/v1/users/${userId}/followers`, ...(params ? [params]: [])] as const;
...
export const postFollow = (
    ...
    return axios.post(
      `http://localhost:4010/internal/v1/users/${userId}/follow`,undefined,options
    );
  }
...
export const getPostFollowMutationKey = (userId: string,) => `http://localhost:4010/internal/v1/users/${userId}/follow` as const;
...
export const usePostFollow = <TError = AxiosError<E400Response | E401Response | E404Response | E500Response | E503Response>>(
  userId: string, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof postFollow>>, TError, string, Arguments, Awaited<ReturnType<typeof postFollow>>> & { swrKey?: string }, axios?: AxiosRequestConfig }
) => {
...
export const deleteFollow = (
    ...
    return axios.delete(
      `http://localhost:4010/internal/v1/users/${userId}/follow`,options
    );
  }
...
export const getDeleteFollowMutationKey = (userId: string,) => `http://localhost:4010/internal/v1/users/${userId}/follow` as const;
...
export const useDeleteFollow = <TError = AxiosError<E400Response | E401Response | E404Response | E500Response | E503Response>>(
  userId: string, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof deleteFollow>>, TError, string, Arguments, Awaited<ReturnType<typeof deleteFollow>>> & { swrKey?: string }, axios?: AxiosRequestConfig }
) => {
...
export const uploadImage = (
    ...
    return axios.post(
      `http://localhost:4010/internal/v1/images`,
...
export const getUploadImageMutationFetcher = ( options?: AxiosRequestConfig) => {
  return (_: string, { arg }: { arg: string }): Promise<AxiosResponse<UploadImage201>> => {
    return uploadImage(arg, options);
  }
}
export const getUploadImageMutationKey = () => `http://localhost:4010/internal/v1/images` as const;
...
export const useUploadImage = <TError = AxiosError<ErrorResponse | void>>(
   options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof uploadImage>>, TError, string, string, Awaited<ReturnType<typeof uploadImage>>> & { swrKey?: string }, axios?: AxiosRequestConfig }
) => {
