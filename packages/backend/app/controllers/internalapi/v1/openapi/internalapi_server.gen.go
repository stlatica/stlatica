...
type ServerInterface interface {
	...
	// (PATCH /internal/v1/users/{user_id})
...
func (w *ServerInterfaceWrapper) DeletePlat(ctx echo.Context) error {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "plat_id", ctx.Param("plat_id"), &platId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true})
	if err != nil {
...
func (w *ServerInterfaceWrapper) GetTimeline(ctx echo.Context) error {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "timeline_id", ctx.Param("timeline_id"), &timelineId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true})
	if err != nil {
...
func RegisterHandlersWithBaseURL(router EchoRouter, si ServerInterface, baseURL string) {
	...
	router.PATCH(baseURL+"/internal/v1/users/:user_id", wrapper.UpdateUser)
