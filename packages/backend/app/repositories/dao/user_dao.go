...
func (dao *userDAO) GetUser(ctx context.Context, userID types.UserID) (*domainentities.User, error) {
	entity, err := entities.FindUser(ctx, dao.ctxExecutor, userID)
	if err != nil {
		return nil, err
	}
...
func (dao *userDAO) GetUserByPreferredUserID(ctx context.Context,
	...
	query := entities.UserWhere.PreferredUserID.EQ(preferredUserID)
...
func convertUserEntityToDomainEntity(entity *entities.User) *domainentities.User {
